...
class PeliculaDAO {
    ...
    static grabeloYa(datos, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield db_connection_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
                let queHacer = 1;
                let respuBase;
                const cubi = yield consulta.one(pelicula_sql_1.SQL_PELICULAS.HOW_MANY_NAME, [datos.nombrePelicula]);
                if (cubi.existe == 0) {
                    queHacer = 2;
                    respuBase = yield consulta.one(pelicula_sql_1.SQL_PELICULAS.ADD, [datos.nombrePelicula, datos.idGenero, datos.duracionPelicula, datos.idioma]);
                }
    ...
    static actualiceloYa(datos, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield db_connection_1.default
                ...
                let queHacer = 1;
                let respuBase;
                const cubi = yield consulta.one(pelicula_sql_1.SQL_PELICULAS.HOW_MANY, [datos.idPelicula]);
                if (cubi.existe > 0) {
                    queHacer = 2;
                    respuBase = yield consulta.one(pelicula_sql_1.SQL_PELICULAS.UPDATE, [datos.idPelicula, datos.nombrePelicula, datos.idGenero, datos.duracionPelicula, datos.idioma]);
                }
                return { queHacer, respuBase };
            }))
                .then(({ queHacer, respuBase }) => {
